...
///**
// * @author : yangshuai
// * @create-date : 2020/4/22 3:33 PM
// * @description :流式布局的LayoutManager
// * @add-version :7726
// **/
...
//        int[] into = new int[lineRows.size()];
//        if (into.length > 0) {
//            for (int i = 0; i < into.length; i++) {
//                into[i] = lineRows.get(i).firstPosition;
//            }
//        }
//        return into;
//    }
...
//        if (into.length > 0) {
//            for (int i = 0; i < into.length; i++) {
//                into[i] = lineRows.get(i).lastPosition;
//            }
//        }
//        return into;
//    }
