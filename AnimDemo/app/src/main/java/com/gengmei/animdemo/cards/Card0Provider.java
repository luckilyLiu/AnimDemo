...
public class Card0Provider extends CardViewProvider<CardBean, Card0Provider.Card1ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull Card1ViewHolder holder, @NonNull CardBean cardBean, int position) {
        ...
        holder.btn.setText("这个是卡片类型为0的卡片");
        holder.btn.setTextColor(holder.itemView.getContext().getResources().getColor(R.color.colorPrimaryDark));
    }
